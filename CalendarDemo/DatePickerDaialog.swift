//
//  DatePickerDaialog.swift
//  CalendarDemo
//
//  Created by Abhi's Mac on 16/02/18.
//  Copyright © 2018 Abhi's Mac. All rights reserved.
//

import UIKit

class DatePickerDaialog: UIView {
    ...
    public func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: NSDate = NSDate(), minimumDate: Date? = nil, maximumDate: Date? = nil, datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping DatePickerCallback) {
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(UIColor.orange, for: UIControlState.normal)
        self.cancelButton.setTitleColor(UIColor.orange, for: UIControlState.highlighted)
        ...
        self.doneButton.setTitleColor(UIColor.orange, for: UIControlState.normal)
        self.doneButton.setTitleColor(UIColor.orange, for: UIControlState.highlighted)
